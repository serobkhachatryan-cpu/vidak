 ...
 * Authenticated owner publish. Lifecycle rules are enforced by CreatorVideoService.
 */
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    const video = await getCreatorVideoService().publishVideo(accessToken, videoId);
